...
namespace Opal.Dfa
{
    public class Dfa
    {
        ...
        public string GetClassReadMethod() => GetReadMethod(MaxClass);

        public string GetStatesReadMethod() => GetReadMethod(States.Length);

        public string GetReadMethod(int max)
        {
            string result;
