...
namespace Opal.Nfa
{
    ...
    public class SingleChar : Segment, IMatch
    {
        ...
        public SingleChar(Token t)
            : base(t)
        {
            Ch = Opal.Containers.Strings.FromEscCharString(t.Value);
        }
        ...
        {
            var ch = obj as SingleChar;
            return !object.Equals(ch, null) && (Ch == ch.Ch);
        }

        public bool Equals(SingleChar ch)
        {
            return Ch == ch.Ch;
        }
        ...
        {
            return other.IsMatch(Ch) ? EmptyMatch.Instance as IMatch : this;
        }
