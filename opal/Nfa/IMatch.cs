...
namespace Opal.Nfa
{
    ...
    {
        public static IMatch Invert(Token t, IMatch match)
        {
            return match.Invert(t);
        }

        public static IMatch Union(IMatch m1, Token t, IMatch m2)
        {
            return m1.Union(m2);
        }

        public static IMatch Difference(IMatch m1, Token t, IMatch m2)
        {
